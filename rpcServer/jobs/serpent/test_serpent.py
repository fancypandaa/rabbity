...
def main():
    ...
    if mode == "-e":
        ...
        print("The Cipher text is: ",help_functions.normal_serpent_encrypt(chunk_messages,user_key) )
        ...
        plain_text_bits = help_functions.normal_serpent_decrypt(bits,user_key)
